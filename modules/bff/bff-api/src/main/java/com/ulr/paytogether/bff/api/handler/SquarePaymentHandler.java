...
import com.ulr.paytogether.bff.event.model.PaymentInitiatedEvent;
import com.ulr.paytogether.bff.event.model.PaymentSuccessfulEvent;
import com.ulr.paytogether.bff.event.model.PaymentFailedEvent;
...
public class SquarePaymentHandler implements ConsumerHandler {
    ...
    public void handlePaymentInitiated(PaymentInitiatedEvent event) {
        ...
        try {
            ...
            PaiementModele paiement = paiementProvider.trouverParCommande(event.getCommandeUuid())
                .stream()
            ...
            // Traiter le paiement via Square
    ...
    public void handlePaymentSuccessful(PaymentSuccessfulEvent event) {
        ...
        try {
            ...
            // livraison Service.demarrerLivraison(event.getCommandeUuid());
